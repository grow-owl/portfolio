        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          <div className="max-w-[560px]">
            ...
            <h1 className="font-sans text-[clamp(36px,4.5vw,52px)] font-bold leading-[1.15] tracking-[-0.04em] text-ink mb-6">
              ...
              Bespoke <span className="text-accent">Web Design Agency</span>
            </h1>

            <p className="text-[17px] text-ink/80 leading-[1.7] mb-9 max-w-[460px]">
              As a full-stack web development and bespoke web design agency, we engineer high-speed Next.js digital experiences, technical SEO marketing, and local search campaigns that dominate rankings and drive revenue.
            </p>
            ...
            <div className="flex gap-3.5 flex-wrap mb-10">
              <a
                ...
                className="inline-flex items-center gap-2 text-sm font-semibold px-7 py-3.5 bg-ink text-white rounded-full hover:bg-accent hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(252,54,55,0.25)] transition-all min-h-[44px]"
              >
                Start a Project
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-sm font-semibold px-7 py-3.5 bg-transparent text-ink border-[1.5px] border-ink/20 rounded-full hover:border-ink hover:bg-ink hover:text-white hover:-translate-y-0.5 transition-all min-h-[44px]"
              >
                See Our Work
              </a>
            </div>
